...
import com.landmuc.kmmtranslator.android.translate.presentation.components.TranslateHistoryItem
...
fun TranslateScreen(
    ...
    // effect handler which triggers whenever a certain state changes
