package com.landmuc.kmmtranslator.core.presentation

import androidx.annotation.DrawableRes
import com.landmuc.kmmtranslator.R
...
actual class UiLanguage(
    ...
    // Locale covers information about a certain language
    // needed for text to speech functionality to read out loud
    // Example: Use a english speaking voice for english text
    fun toLocale(): Locale? {
